  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://hotel-backend-tge7.onrender.com/partner/create/new",
        {
          method: "POST",
          body: formData,
        }
      ...
      <nav className="navbarparner">
        <ul>
          ...
          <li>
            <a
              href="#"
              onClick={() => openTab("tariff")}
              className={activeTab === "tariff" ? "active" : ""}
            >
              Hotel Tariff
            </a>
          </li>
        ...
        <form className="form1" onSubmit={handleSubmit}>
          ...
          <div className="section1st">
            ...
            <div className="1st-tisra">
              <label htmlFor="receptioncontact">
                Reception Contact Detail:
              </label>
              <input
                type="text"
                id="receptioncontact"
        ...
        <div className="basic-container">
          ...
          <div class="flex-container">
            ...
            <img
                ...
                alt="Image 9"
              />
              <h6>Resturant-Image</h6>
            </div>
          </div>
          <div class="flex-container">
            <div>
              <img
                src="https://tse2.mm.bing.net/th?id=OIP.7mUp-n4AqHmk7U69YNwSowHaFj&pid=Api&P=0&h=180"
                alt="Image 9"
              />
              <h6>Parking-Image</h6>
            </div>
            <div>
            <img
                src="https://3.bp.blogspot.com/-ChV-6ws5dmU/V7YRUpA1wVI/AAAAAAAAHSQ/dOy84jA9zDAryj2oOuBRuQJe6PURVTsOQCLcB/s1600/IMG_2693.JPG"
                alt="Image 9"
              />
              <h6>Lane-Image</h6>
            </div>
            <div>
            <img
                src="https://tse2.mm.bing.net/th?id=OIP.hxTP-lK5e9HnXu0alJp-LgHaE8&pid=Api&P=0&h=180"
                alt="Image 9"
              />
              <h6>HotelFront-Image</h6>
            </div>
          </div>
<div className="partner-style">
        ...
        <div className="policy-section">
          ...
          <div className="policy-heading">
            ...
            <div className="policy-item">
              ...
              <div className="allow">
                ...
                <label htmlFor="allowedCheckbox">Allowed</label>
              </div>
              <div className="allow">
                <input type="checkbox" id="notAllowedCheckbox" />
                <label htmlFor="notAllowedCheckbox">Not Allowed</label>
              </div>
            </div>
            <div className="policy-item">
          ...
          <div className="memo">
            ...
            <p className="checkin-rules">
              1-Early Check-in the Standard Check-in time in hotels is 12 noon
              unless mentioned otherwise in your Booking voucher Early Check in
              is Subject to availability Extra changes will usually apply as per
              below policy
            </p>
          </div>
          <div className="table-checkin">
            <table>
              ...
              <tbody>
                <tr>
                  <td>Before 6AM</td>
                  <td>
                    100% Charges for one day payable as per room rates for the
                    previous day
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    0% to 30% charges payable as per room rates for the previous
                    day
                  </td>
                </tr>
                <tr>
            ...
            <p>
              Complimentary breakfast will not be available to you for the day
              of early Check-in
            </p>
          </div>
          <div className="memo">
            <p className="checkin-rules">
              ...
              Unless mentioned otherwise in your Booking Voucher.Late check-out
              is subjected to availability and can not be confirmed with the
              hotel in advance.Extra charges will usually apply per the below
              policy.
            </p>
          </div>
          <div className="table-checkin">
