...
const Footer = () => {
  ...
  const isSearchResultsPath = location.pathname.startsWith("/search/results/");
        ...
        <section className="">
          <MDBRow>
            ...
            <MDBCol lg="3" md="6" className="mb-4 mb-md-0">
              <ul className="list-unstyled mb-0">
                <li className="citylist-name">
                  <a href="/search/results/patna" class="text-white">
                    Hotels in Patna
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/vadodara" class="text-white">
                    Hotels in Vadodara
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/surat" class="text-white">
                    Hotels in Surat
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/ratlam" class="text-white">
                    Hotels in Ratlam
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/gwalior" class="text-white">
                    Hotels in Gwalior
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/rishikesh" class="text-white">
                    Hotels in Rishikesh
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/nainital" class="text-white">
                    Hotels in Nainital
                  </a>
                </li>
                <li className="citylist-name">
                  <a href="/search/results/mussoorie" class="text-white">
                    Hotels in Mussoorie
                  </a>
                </li>
                <Dropdown>
                  ...
                  <Dropdown.Menu>
                    <Dropdown.Item href="/search/results/dehradun">
                      Hotels in Dehradun
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/haridwar">
                      Hotels in Haridwar
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/jamnagar">
                      Hotels in Jamnagar
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/bhopal">
                      Hotels in Bhopal
                    </Dropdown.Item>{" "}
                    <Dropdown.Item href="/search/results/jamnagar">
                      Something else
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/noida">
                      Hotels in Noida
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/lucknow">
                      Hotels in Lucknow
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/jabalpur">
                      Hotels in Jabalpur
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/indore">
                      Hotels in Indore
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/nalanda">
                      Hotels in Nalanda
                    </Dropdown.Item>{" "}
                    <Dropdown.Item href="/search/results/nalanda">
                      Something else
                    </Dropdown.Item>
                    <Dropdown.Item href="/search/results/gaya">
                      Hotels in Gaya
                    </Dropdown.Item>
                  </Dropdown.Menu>
                </Dropdown>
