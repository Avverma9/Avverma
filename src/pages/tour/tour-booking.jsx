...
export default function TourBookPage() {
  ...
  const [finalPrice, setFinalPrice] = useState(travelById?.price || 0);
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-8 bg-white p-4 sm:p-6 rounded-2xl shadow-xl border">
              ...
              <div className="space-y-3 mb-6">
                <p><strong>From:</strong> {formatDate(travelById.from)}</p>
                <p><strong>To:</strong> {formatDate(travelById.to)}</p>
