...
export default function Header() {
  ...
  return (
    <>
      ...
      {/* Mobile Menu Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-full max-w-xs bg-white/10 backdrop-blur-2xl shadow-2xl transform transition-all duration-300 ease-in-out z-50 border-r border-white/20 ${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"
          }`}
      >
