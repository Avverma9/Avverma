    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.status === 201) {
                setSnackbar({ open: true, message: 'Your food has been added!', severity: 'success' });
                setTimeout(() => {
                    navigate('/partner/last-step');
                }, 1500);
            } else {
                setSnackbar({ open: true, message: 'Failed to add food. Please try again.', severity: 'error' });
            }
        } catch (error) {
                    ...
                    >
                        <Stack spacing={2}>
                            <Typography variant="p4" component="h6" align="center">
                               Manage food items for your hotel
                               Add food items to your hotel to enhance guest experience.
                            </Typography>
