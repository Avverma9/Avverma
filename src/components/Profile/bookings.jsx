...
const BookingModal = ({ show, handleClose, modalData }) => {
  ...
  const roomTotal =
    calculateTotal(modalData?.roomDetails, "price") *
    (Number(modalData?.numRooms) || 1);
            ...
            <Grid container spacing={4}>
              ...
              <Grid item xs={12} sm={6} md={3}>
                ...
                <Typography variant="h6">
                  {moment(modalData?.createdAt).format("Do MMM YYYY")}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6} md={3}>
          ...
          <Box mb={4}>
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} sm={6}>
                ...
                <Typography variant="h6">
                  {modalData?.hotelDetails?.hotelName}
                </Typography>
              </Grid>
              <Grid item xs={12} sm={6}>
          ...
          <Box>
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} sm={6} md={4}>
                ...
                <PriceDetail
                  label={`GST (${modalData?.gstPrice || 0}%)`}
              ...
              <Grid item xs={12} sm={6} md={4}>
                <PriceDetail
                  label="Discount"
                  value={
                    discountAmount > 0 ? `- ₹${discountAmount}` : "No Discount"
                  }
                />
    ...
    <Box sx={bookingHeaderStyle}>
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        ...
        <Typography variant="body2">
          {moment(bookingDetail?.createdAt).format("MMMM DD, YYYY")}
        </Typography>
      </Stack>
    </Box>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6} md={6}>
          ...
          <Typography variant="body1" fontWeight="bold">
            ...
            {bookingDetail.guests > 1 ? "Adults" : "Adult"}
          </Typography>
        </Grid>
        <Grid item xs={6} md={6}>
          <Typography
      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center">
        ...
        <Stack direction="row" spacing={1}>
          <Button
            size="small"
            variant="outlined"
            onClick={() => onShowDetails(bookingDetail)}
          >
            View Details
          </Button>
          <Button
            size="small"
            variant="contained"
            onClick={() => onReview(bookingDetail?.hotelDetails?.hotelId)}
          >
            Review
          </Button>
        </Stack>
