...
// Reusable component for displaying each piece of profile information
...
// Special component for the password field
...
export default function Profile() {
  ...
  if (error) {
    return <Typography color="error" sx={{ p: 3 }}>Error loading profile data: {error.message}</Typography>;
  }
