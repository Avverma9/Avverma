            ...
            {filteredCountries.map((country) => (
              <button
                ...
                className={`country-option ${
                  country.code === selectedCode ? "selected" : ""
                }`}
...
export default function LoginPage() {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      let response;
      if (authMethod === "email") {
        response = await axios.post(`${baseURL}/mail/verify-otp/site`, {
          email,
          otp,
        });
      } else {
      ...
      <div className="login-card" role="main">
        ...
        {mode === "otp" && (
          <div
            ...
            role="group"
            aria-label="Select OTP method"
          >
            <button
              type="button"
              className={`method-chip ${
                authMethod === "email" ? "selected" : ""
              }`}
