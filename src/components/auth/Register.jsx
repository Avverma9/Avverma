...
export default function RegisterPage() {
  ...
  return (
     ...
     <div className="bg-gradient-to-br from-blue-50 via-white to-cyan-50 font-sans">
      <div className="min-h-screen flex justify-center items-center p-4">
        <div className="w-full max-w-lg bg-white rounded-2xl shadow-2xl p-8 flex flex-col gap-6" role="main">
          ...
          <div className="text-center text-sm text-gray-700">
            ...
            <a href="/login" className="text-indigo-600 font-medium no-underline hover:underline">
              Sign In
            </a>
          </div>
        </div>
