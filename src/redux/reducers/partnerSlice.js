...
export const postRooms = createAsyncThunk('partner/postRooms', async (formData, { rejectWithValue }) => {
    try {
        const response = await axios.post(`${baseURL}/create-a-room-to-your-hotel`, formData);
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(postRooms.rejected, (state, action) => {
                ...
                toast.error(`Failed to post room: ${action.payload || 'Unknown error'}`);
            })
            ...
            .addCase(sendNotification.rejected, (state, action) => {
                ...
                toast.error(`Failed to send notification: ${action.payload || 'Unknown error'}`);
            });
    },
});
